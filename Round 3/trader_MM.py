...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        if best_ask_GB < ratio_short * acceptable_price_short_GB:
            ...
            orders_C.append(Order('CHOCOLATE', best_bid_C, - best_bid_amount_C)) # I Sell 4 chocolates
            orders_S.append(Order('STRAWBERRIES', best_bid_S, - best_bid_amount_S)) # I Sell 6 strawberries
            orders_R.append(Order('ROSES', best_bid_R, - best_bid_amount_R)) # I Sell 1 rose
        ...
        if best_bid_GB > ratio_long * acceptable_price_long_GB:
            ...
            orders_C.append(Order('CHOCOLATE', best_ask_C, - best_ask_amount_C)) # I Buy 4 chocolates
            orders_S.append(Order('STRAWBERRIES', best_ask_S, - best_ask_amount_S)) # I Buy 6 strawberries
            orders_R.append(Order('ROSES', best_ask_R, - best_ask_amount_R)) # I Buy 1 rose
        ...
        if best_ask_R < ratio_short * acceptable_price_short_R:
            ...
            orders_GB.append(Order('GIFT_BASKET', best_bid_GB, - best_bid_amount_GB)) # I Sell Gift Basket
            orders_C.append(Order('CHOCOLATE', best_ask_C, - best_ask_amount_R)) # I Buy 4 chocolates
            orders_S.append(Order('STRAWBERRIES', best_ask_S, - best_ask_amount_S)) # I Buy 6 strawberries
