...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        acceptable_price_long_GB = 4 * best_ask_C + 6 * best_ask_S + best_ask_R
        acceptable_price_short_GB = 4 * best_bid_C + 6 * best_bid_S + best_bid_R
        ...
        acceptable_price_long_C = 0.25 * (best_ask_GB - 6 * best_ask_S - best_ask_R)
        acceptable_price_short_C = 0.25 * (best_bid_GB - 6 * best_bid_S - best_bid_R)
        ...
        acceptable_price_long_S = (best_ask_GB - 4 * best_ask_C - best_ask_R) / 6
        acceptable_price_short_S = (best_bid_GB - 4 * best_bid_C - best_bid_R) / 6
        ...
        acceptable_price_long_R = (best_ask_GB - 4 * best_ask_C - 6 * best_ask_S)
        acceptable_price_short_R = (best_bid_GB - 4 * best_bid_C - 6 * best_bid_S)
